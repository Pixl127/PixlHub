...
-- Farm Tab
--------------------------------------------------------
local AutoBreakRbLb = FarmTab:CreateToggle({
   Name = "Auto Break Rainbow Lucky Block",
   CurrentValue = false,
   Flag = "Toggle1",
...
local AutoBreakPartyCrate = FarmTab:CreateToggle({
   Name = "Auto Break Party Crate",
   CurrentValue = false,
   Flag = "Toggle1",
   Callback = function(Value)
...
-- Egg Tab
--------------------------------------------------------
local AutoOpenEgg = EggTab:CreateToggle({
   Name = "Auto Open Egg",
   CurrentValue = false,
   Flag = "Toggle1",
   Callback = function(Value)
